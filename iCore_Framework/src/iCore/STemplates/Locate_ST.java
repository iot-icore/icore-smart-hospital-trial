...
/**
 * The Class Locate Service Template
 * 
 *  @author Swaytha Sasidharan
 *  @version 1.0
 *  @since 01.11.2014 
 */
public class Locate_ST implements ServiceTemplate{
	...
	public void execute(String filepath_ruleflow, String file){
        ...
        try {
            ...
            KnowledgeRuntimeLogger logger = KnowledgeRuntimeLoggerFactory.newFileLogger(ksession, "test1");
